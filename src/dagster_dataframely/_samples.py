...
#: The valid output's materialization display key. Short and unprefixed, like `stats/*` and unlike the fully qualified schema carrier: the difference in length tells a reader which keys are for them.
SAMPLE_KEY = "sample"
