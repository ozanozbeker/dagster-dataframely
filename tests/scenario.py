...
Covers the cases the whole effort needs: the dtypes a round trip or a metadata emission could get wrong, and the rule shapes the naming and description fallbacks have to distinguish.
