...
The guide's [Hand-wiring](https://ozanozbeker.github.io/dagster-dataframely/user-guide/hand-wiring.html) section already answers it: "Nothing will be added to `dd.wiring` to make reassembling the decorator easier."
