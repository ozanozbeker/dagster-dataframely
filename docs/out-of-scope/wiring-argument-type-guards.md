...
[ADR-0001](../adr/0001-process-takes-asset-keys.md) settles that hand-wiring does not shape this package's design, and the README says "Nothing will be added to `dd.wiring` to make reassembling the decorator easier".
