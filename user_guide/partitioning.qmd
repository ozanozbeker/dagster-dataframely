...
![A day-by-region grid with one cell selected. Validation ran per partition, so the row count and the statistics on the right belong to that cell alone.](../assets/images/partitions-grid.png)
